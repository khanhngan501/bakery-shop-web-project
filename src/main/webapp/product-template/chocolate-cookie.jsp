    ...
    <c:if test="${sessionScope.acc.isAdmin != 1}">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="item">
              <img class="main_img" src="../images/bread14-detail1.jpg" />
          </div>
          <div class="item">
              <img src="../images/bread14-detail2.jpg" />
          </div>
          <div class="item">
              <img src="../images/bread14-detail3.jpg" />
          </div>
        ...
        <div id="thumb" class="owl-carousel product-thumb">
          ...
          <div class="item">
              <img src="../images/bread14-detail1.jpg" />
          </div>
          <div class="item">
              <img src="../images/bread14-detail2.jpg" />
          </div>
          ...
          <div class="col-md-6">
            <div class="product-dtl">
              ...
              <p>A guest favorite! A classic cookie with Belgian chocolate chips, a chewy center, and crisp edges.</p>
